...
<body class="body">
	...
	<nav class="nav">
		<div class="container">
			...
			<ul>
				...
				<li><a href="${MANAGE}/ManageOrder" class="current">Manage
						Order</a></li>
				...
				<table class="tables table table-stripe">
					...
					<c:forEach var="item" items="${order_now}">
						<tr>
							...
							<td>Cooking</td>
							<td><a
								href="<c:url value='/Manage/View?action=view&ID=${item.id}'></c:url>">View</a>
								<a
								href="<c:url value='/Manage/ManageOrder?action=finished&ID=${item.id}'></c:url>">Finished</a>
							</td>
						</tr>
					</c:forEach>
				</table>
					...
					<c:forEach var="item" items="${order_wait}">
						<tr>
							...
							<td><a
								href="<c:url value='/Manage/View?action=view&ID=${item.id}'></c:url>">View</a>
								<a
								href="<c:url value='/Manage/ManageOrder?action=accept&ID=${item.id}'></c:url>">Accept</a>
								<a
								href="<c:url value='/Manage/ManageOrder?action=deny&ID=${item.id}'></c:url>">Deny</a>
	...
	<div>
		<c:out value="${sessionScope.error_view_order}"></c:out>
	</div>
	<script
